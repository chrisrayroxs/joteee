...
function shaper() {
    ...
    var Y12 = (e.pageY) - 8;
/*
	$('#canvas').append('<svg id="canvasSVG" xmlns="http://www.w3.org/2000/svg" version="1.1"><path d="M150 0 L75 200 L225 200 Z" />0</svg>');
*/
		// Creates canvas
	...
	$('#canvas svg').draggable({ containment: "#canvas" });
